...
urlpatterns = [
    ...
    path("whishlist/",views.show_whishlist, name='showhishlist'),
...
admin.site.site_header = "Milk Shop Admin Login"
admin.site.site_title = "Milk Shop Admin"
admin.site.site_index_title = "Welcome to Trung Nguyen Milk Shop"